...
def call(Map buildParams) {
    ...
    if (!buildParams.hasProperty("nodeMin") && !buildParams.nodeMin) { buildParams.nodeMin = "${getProperty("buildParams.nodes")}" }
    if (!buildParams.hasProperty("nodeMax") && !buildParams.nodeMax) { buildParams.nodeMax = "${getProperty("buildParams.nodes")}" }

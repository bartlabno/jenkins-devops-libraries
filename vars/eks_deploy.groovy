...
def call(Map buildParams) {
    ...
    if (!buildParams.hasProperty("nodeMin") && !buildParams.nodeMin) { buildParams.nodeMin = 4 }
    if (!buildParams.hasProperty("nodeMax") && !buildParams.nodeMax) { buildParams.nodeMax = 4 }

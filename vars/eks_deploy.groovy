...
def call(Map buildParams) {
    ...
    if (!buildParams.hasProperty("nodeMin") && !buildParams.nodeMin) { buildParams.nodeMin = sh "echo ${buildParams.nodes}" }
    if (!buildParams.hasProperty("nodeMax") && !buildParams.nodeMax) { buildParams.nodeMax = sh "echo ${buildParams.nodes}" }

...
def call(Map buildParams) {
    ...
    node ( label: 'awscli' ) {
        ...
        stage("deploy ${buildParams.env}") {
            ...
            sh script: "echo \"AlterRole: \$(if [ \$(cat ./infrastructure/k8s/values.yaml | grep -c \"Role: blue\") -eq 0 ]; then echo green; else echo blue; fi)\" >> ./infrastructure/k8s/values.yaml", label: "building helm values - alter role"
